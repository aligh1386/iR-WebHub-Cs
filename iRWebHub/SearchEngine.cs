...
namespace iRWebHub
{
    public partial class SearchEngine : UserControl
    {
        ...
        private void Engine1_Click(object sender, EventArgs e)
        {
            string url = "https://zarebin.ir/";
            Process.Start(url);
        }

        private void Engine2_Click(object sender, EventArgs e)
        {
            string url = "https://gerdoo.me/";
            Process.Start(url);
        }

        private void Engine3_Click(object sender, EventArgs e)
        {
            string url = "https://shaadbin.ir/";
            Process.Start(url);
        }

        private void Engine4_Click(object sender, EventArgs e)
        {
            string url = "https://search.bertina.ir/";
            Process.Start(url);
        }
    }
}
