...
namespace iRWebHub
{
    public partial class BuyFood : UserControl
    {
        public BuyFood()
        {
            InitializeComponent();
        ...
        private void BuyFood1_Click(object sender, EventArgs e)
        {
            string url = "https://snappfood.ir/";
            Process.Start(url);
        }

        private void BuyFood2_Click(object sender, EventArgs e)
        {
            string url = "https://order.tapsi.food/";
            Process.Start(url);
        }

        private void BuyFood3_Click(object sender, EventArgs e)
        {
            string url = "https://www.delino.com/";
            Process.Start(url);
        }
